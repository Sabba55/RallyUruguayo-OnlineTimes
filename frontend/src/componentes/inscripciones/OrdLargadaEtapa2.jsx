...
function OrdLargadaEtapa2({ onVolver }) {
  ...
  const cargarHorarios = async () => {
    try {
      setCargando(true);
      const datos = await obtenerHorariosEtapa2();
    ...
    <div className="contenedor-orden-largada">
        <div className="filtros-orden-largada">
            <div className="filtro-grupo-orden-largada">
                <label htmlFor="filtroPilotoEtapa2">Buscar piloto</label>
                <input
                    id="filtroPilotoEtapa2"
                    type="search"
            ...
            <div className="filtro-grupo-orden-largada">
                <label htmlFor="filtroCategoriaEtapa2">Categoría</label>
                <select
                    id="filtroCategoriaEtapa2"
                    className="filtro-control-orden-largada"
...
export default OrdLargadaEtapa2;
